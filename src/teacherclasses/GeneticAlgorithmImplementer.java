...
//        }
    ...
    public static void writeAvgRatingToExcel(Solution solution, Data data,String sheetName) throws IOException {
        XSSFWorkbook workbook = new XSSFWorkbook();
        ...
        try (FileOutputStream outputStream = new FileOutputStream("Averag"+sheetName+".xlsx")) {
            workbook.write(outputStream);
            outputStream.close();
        }
    }
